...
:mod:`server.tools.discovery` and the global search tool lives in
:mod:`server.tools.search`; they are re-exported here so callers can import
...
from server.tools.generic import legal_run_operation
from server.tools.search import legal_search
